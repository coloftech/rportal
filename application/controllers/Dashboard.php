...
class Dashboard extends CI_Controller
{
	...
	public function index()
	{
       ...
       //$a = $this->aauth->update_user($user->id, $user->email, 'admin123', $user->username);
		...
		<div class='col-md-4'><p class='alert alert-info'><a href='#' class='btn'>Recents download</a></p><p>$dl</p></div>
		<div class='col-md-4'><p class='alert alert-info'><a href='#' class='btn'>Recents upload</a></p><p>$up</p></div>
		<div class='col-md-4'><p class='alert alert-info'><a href='#' class='btn'>Login attempts</a></p><p>$att</p></div>
		<div class='divider divider-line'></div>
		</div>


		<div class='col-sm-12 col-md-12 col-lg-12'>
		<div class='col-md-4'><p class='alert alert-warning'><a href='#' class='btn'>Recents added user</a></p><p>-</p></div>
